# LMAutocomplete: Terminal natural-language command assistant
...
This project aims to solve this issue safely. To achieve that, command generation by LLM is a fallback option and deterministic generation from templates are encouraged.
